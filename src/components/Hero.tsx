        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm font-semibold text-gray-400">Powered by <span className="text-yellow-700">Bolt.new</span> + <span className="text-emerald-500">Supabase</span> + <span className="text-teal-500">Netlify</span> + <span className="text-stone-500">Entri</span> + <span className="text-blue-800">IONOS</span> + <a href="https://publast" className="text-blue-800">Publast</a></p>
