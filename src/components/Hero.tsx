        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm font-semibold text-gray-400">Powered by <span className="text-gold">Bolt.new</span> + <span>Supabase</span> + <span>Netlify</span> + <span>Entri / IONOS</span></p>
