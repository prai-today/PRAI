          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16 max-w-6xl mx-auto">
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:shadow-xl transition-all hover:scale-105 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                PRAI analyzes your website and generates effective core message and keywords that help AI understand and recognize your product.
              </p>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:shadow-xl transition-all hover:scale-105 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                PRAI edits optimized contents and publishes strategically to public websites, ensuring AI and search engines can find, understand, and answer your product.
              </p>
            </div>
