        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm font-semibold text-gray-400">Powered by <span className="text-yellow-700">Bolt.new</span> + <span className="text-green-500">Supabase</span> + <span>Netlify</span> + <span>Entri / IONOS</span></p>
