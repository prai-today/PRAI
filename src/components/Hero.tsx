...
export function Hero() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center overflow-hidden">
      ...
      <div className="absolute z-100 top-16 right-4 sm:top-6 sm:right-6 md:top-10 md:right-10 lg:top-16 lg:right-16">
        
      <img src="/bolt.png" alt="" className="w-20 md:w-28 lg:w-32 2xl:w-36" />
      </div>
