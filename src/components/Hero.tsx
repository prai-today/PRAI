...
export function Hero() {
  ...
  <a href="https://bolt.new/" target="_blank" rel="noopener noreferrer">
    <img
      src="/bolt.png"
      alt="Bolt.new"
      className="w-16 sm:w-18 md:w-22 lg:w-24 xl:w-28 2xl:w-32 transition-transform hover:animate-spin-slow"
    />
  </a>
</div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <p className="text-xs sm:text-sm font-semibold text-gray-400 px-4">
                Powered by <a href="https://bolt.new/" target="_blank" rel="noopener noreferrer" className="text-yellow-700">Bolt.new</a> + <a href="https://supabase.com/" target="_blank" rel="noopener noreferrer\" className="text-emerald-500">Supabase</a> + <a href="https://www.netlify.com/" target="_blank" rel="noopener noreferrer\" className="text-teal-500">Netlify</a> + <a href="https://www.entri.com/" target="_blank" rel="noopener noreferrer\" className="text-stone-500">Entri</a> + <a href="https://www.ionos.com/" target="_blank" rel="noopener noreferrer\" className="text-blue-800">IONOS</a>
              </p>
